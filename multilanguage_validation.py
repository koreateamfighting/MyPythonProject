...
# Form implementation generated from reading ui file 'multilanguage_validation.ui'
#
...
class ListBoxWidget(QListWidget):
    ...
    def dropEvent(self, event):
        ...
        if event.mimeData().hasUrls():
            ...
            table = QTableWidget()    
            verticalLayout_2.replaceWidget(listbox_view1,table)
    ...
    def loadExcelData(self, excel_file_dir, worksheet_name):
        ...
        for row in tqdm(df.iterrows(),mininterval=0.001,ncols=100,leave=True):
            values = row[1]
